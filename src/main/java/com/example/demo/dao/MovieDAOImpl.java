...
public class MovieDAOImpl implements MovieDAO {
	...
	public List<Movie> getAllMovieByCategory(String categoryname) {
		// TODO Auto-generated method stub
		System.out.println("Executing : " + QUERY_GET_MOVIES_BY_CATEGORY_NAME );
        System.out.println("Executing : " +categoryname);

        List<Movie> movie = jdbcTemplate.query(QUERY_GET_MOVIES_BY_CATEGORY_NAME , new MovieMapper(),categoryname);
        return movie ;
	}
